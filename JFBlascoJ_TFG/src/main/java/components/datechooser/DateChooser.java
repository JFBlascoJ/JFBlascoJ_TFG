...
public final class DateChooser extends javax.swing.JPanel {
    ...
    public void setLookAndFeel(Colores colores) {
        this.colores = colores;
        popup.setBackground(Colores.TRANSPARENTE);
        header.setBackground(Colores.NARANJA);
    }
    ...
    public void setTextRefernce(JTextField txt) {
        ...
        this.textRefernce.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent me) {
                if (textRefernce.isEditable()) {
                    showPopup();
                }
            }
        });
            textRefernce.setText("");
    }
    ...
    private Event getEventMonth() {
        return (MouseEvent evt, int num) -> {
            ...
            if (slide.slideToDown(d)) {
                cmdMonth.setText(MONTHS[MONTH - 1]);
    ...
    private void initComponents() {
        ...
        cmdReset = new components.datechooser.Button();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon("E:\\TFG\\JFBlascoJ_MongoDB\\JFBlascoJ_SalaEventos\\assets\\icons\\forward.png")); // NOI18N
        ...
        cmdMonth.setFont(Fuentes.LABEL);
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon("E:\\TFG\\JFBlascoJ_MongoDB\\JFBlascoJ_SalaEventos\\assets\\icons\\previous.png")); // NOI18N
        ...
        cmdPrevious.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        cmdReset.setIcon(new javax.swing.ImageIcon("E:\\TFG\\JFBlascoJ_MongoDB\\JFBlascoJ_SalaEventos\\assets\\icons\\EraserBlanco20.png")); // NOI18N
        cmdReset.setFocusable(true);
        cmdReset.setPaintBackground(false);
        cmdReset.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdResetActionPerformed(evt);
            }
        });
        cmdReset.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmdResetKeyPressed(evt);
            }
        });
        ...
        headerLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, headerLayout.createSequentialGroup()
                ...
                .addComponent(cmdReset, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(MY, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(40, 40, 40)
    ...
    private void cmdResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdResetActionPerformed
        selectedDate.setDay(0);
        textRefernce.setText("");
    }//GEN-LAST:event_cmdResetActionPerformed

    private void cmdResetKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmdResetKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmdResetKeyPressed
    ...
    private components.datechooser.Button cmdReset;
    ...
    public SelectedDate getSelectedDate() {
        ...
        return DAY == 0 ? null : selectedDate;
    }
